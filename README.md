...
There are some limitations and opther things to consider when using Grünenthal AI Chatbot:
 ...
 - Although the Agent has the ability to use its own knowledge to enhance tool responses with further information (as per the initial configuration prompt provided), it often does not. Further, it does not use often two tools to answer one question. These limitations should be investigated further in the future.
...
|BONUS:<br> - What is the most referenced drug in Grunenthal's financial report? (Works - Tapentadol)<br> - According to FDA, what are the most common adverse events for Tapentadol? (Works)<br> - What is the most referenced drug in Grunenthal's financial report? According to FDA, what are the 3 most common adverse events for that drug? (Works sometimes, separate questions)<br> - According to FDA, what are the 3 most common adverse events for the number one most referenced drug in Grunenthal's financial report? (Does not work) | Testing the use of more than one tool in the same query |

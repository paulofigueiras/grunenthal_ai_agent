...
|BONUS: 
 - What is the most referenced drug in Grunenthal's financial report? (Works - Tapentadol)
 - According to FDA, what are the most common adverse events for Tapentadol? (Works)
 - What is the most referenced drug in Grunenthal's financial report? According to FDA, what are the 3 most common adverse events for that drug? (Works sometimes, seprated questions)
 - According to FDA, what are the 3 most common adverse events for the number one most referenced drug in Grunenthal's financial report? (Does not work) | Testing the use of more than one tool in the same query |
